...
const WIRE: { [K in keyof GrokSettings]: Wire } = {
  ...
  voiceSttLanguage: { kind: "string", path: ["ui", "voice_stt_language"] },
  imageGen: { kind: "bool", path: ["features", "image_gen"] },
  videoGen: { kind: "bool", path: ["features", "video_gen"] },
  voiceMode: { kind: "bool", path: ["features", "voice_mode"] },
